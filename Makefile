...
interchaintest: gen ## Build interchaintest binary into ./bin
	go test -ldflags "-X github.com/odin-protocol/interchaintest/v7/internal/version.GitSha=$(shell git describe --always --dirty)" -c -o ./bin/interchaintest ./cmd/interchaintest
